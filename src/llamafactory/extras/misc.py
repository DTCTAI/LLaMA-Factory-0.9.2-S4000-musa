...
def get_current_device() -> "torch.device":
    ...
    if is_torch_xpu_available():
        ...
        device = "musa:{}".format(os.environ.get("LOCAL_RANK", "0"))
    else:
        device = "cpu"
...
def get_device_count() -> int:
    ...
    elif is_torch_musa_available():  # 修改1musa
...
def is_gpu_or_npu_available() -> bool:
    ...
    """
    return is_torch_npu_available() or is_torch_cuda_available() or is_torch_musa_available()
